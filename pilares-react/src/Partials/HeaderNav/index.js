...
import {NavLogo, HeaderCtn, NavBrand, NavList , NavItem , NavButton} from './styled'

export function HeaderNav(){
    const navTitle = "ASTRO-SIDE"
...
return(
    <div>
        ...
        <NavBrand> 
            ...
            <NavLogo src={navLogoImg} alt="logo brand" />
            
            </NavBrand>


<NavList>
<NavItem><NavButton>HOME</NavButton></NavItem>    
<NavItem><NavButton>HOME</NavButton></NavItem>    
<NavItem><NavButton>HOME</NavButton></NavItem>    


</NavList>    <HeaderCtn>    <h1>{navTitle}</h1>
